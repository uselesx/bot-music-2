  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('RICK ROOL').setURL("https://www.youtube.com/watch?v=dQw4w9WgXcQ")
        let button_invite = new MessageButton().setStyle('url').setLabel('Invite Server').setURL("https://discord.gg/BSmvW3BH")
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)
        ...
        let d_button_dc = new MessageButton().setStyle('url').setLabel('Inutile Server').setURL("https://discord.gg/2fKTMkXuh5");
        let d_button_invite = new MessageButton().setStyle('url').setLabel('Inutile Channel Youtube').setURL("https://www.youtube.com/channel/UCSpTLThXbKLxjHaCYoQgT-A");
      ...
      function allotherembeds() {
        ...
        var embed5 = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setTitle("<:Inutile:840259659163893820> Bot Creator")

          .addField(`> ***[Inutile Development](https://discord.gg/BSmvW3BH)***\n>`)
          .addField(`<Inutile#0001> **__Bot Creator Information__**`, `>>> 💯 This Bot has been made by Wumpus :\n[Discord](https://discord.gg/BSmvW3BH)<:Discord:787321652345438228>`)
          .setFooter(`Page 6 / 6  \nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL());
        embeds.push(embed5)
        return embeds
      }
